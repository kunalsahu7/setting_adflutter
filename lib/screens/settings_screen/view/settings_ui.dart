...
class _settingsState extends State<settings> {
  ...
  Widget build(BuildContext context) {
      provifalse= Provider.of(context,listen: false);
      provitrue= Provider.of(context,listen: true);
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          title: Text("Settings"),
        ...
        body:Column(
          children: [
            ...
            Container(
              ...
              child: ListTile(
                title:Text("Enviroment",style: TextStyle(color: Colors.black)),
            ...
            Container(
              ...
              child: ListTile(
                title:Text("Phone number",style: TextStyle(color: Colors.black)),
            ...
            Container(
              ...
              child: ListTile(
                title:Text("Lock app in Background",style: TextStyle(color: Colors.black)),
            ...
            Container(
              ...
              child: ListTile(
                title:Text("Use fingerprint",style: TextStyle(color: Colors.black)),
            ...
            Container(
              ...
              child: ListTile(
                title:Text("Chang Passwored",style: TextStyle(color: Colors.black)),
